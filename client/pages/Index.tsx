...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-3xl text-gray-300 max-w-4xl mx-auto leading-relaxed font-light">
              <span className="text-neon font-bold">MERN Stack Developer</span>{" "}
      ...
      <section
        id="about"
        className="py-32 relative bg-gradient-to-br from-purple-900/20 via-black to-cyan-900/20"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              ...
              <div className="relative glassmorphism rounded-3xl p-8 border border-pink-500/30">
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  ...
                  . I love to use my creativity and make something new. Try
                  creating visually appealing and highly functional web
                  interfaces. Proficient in HTML, CSS, and JavaScript with a
                  strong foundation in modern front-end frameworks React.
                </p>
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  ...
                  - a collection of powerful technologies used to develop
                  scalable master web applications comprising backend,
            ...
            <div className="relative">
              <div className="aspect-square relative">
                {/* Main Circle */}
                <div
                  className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 p-1 animate-spin"
      ...
      <section
        id="skills"
        className="py-32 bg-gradient-to-br from-black via-purple-900/10 to-black"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              ...
              <span className="text-neon font-bold">extraordinary</span> digital
              experiences
            </p>
          </div>
      ...
      <section
        id="experience"
        className="py-32 bg-gradient-to-br from-cyan-900/10 via-black to-purple-900/10"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-6xl font-black text-white mb-6">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              The evolution of a{" "}
              <span className="text-neon font-bold">digital creator</span>
            </p>
          </div>
      ...
      <section
        id="projects"
        className="py-32 bg-gradient-to-br from-black via-pink-900/10 to-black"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-6xl font-black text-white mb-6">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              ...
              <span className="text-neon font-bold">innovation</span> and
              creativity
            </p>
          </div>
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex space-x-4">
                      <a
                        ...
                        className="flex-1 group/btn relative overflow-hidden rounded-full"
                      >
                        <div
                      ...
                      <a
                        ...
                        className="px-6 py-3 rounded-full border border-white/30 text-white hover:bg-white/10 transition-all flex items-center space-x-2"
                      >
      ...
      <section
        id="blog"
        className="py-32 bg-gradient-to-br from-purple-900/10 via-black to-cyan-900/10"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-6xl font-black text-white mb-6">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              ...
              <span className="text-neon font-bold">future</span> of web
              development
            </p>
          </div>
      ...
      <section id="contact" className="py-32 relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
              Ready to bring your{" "}
              <span className="text-neon font-bold">wildest ideas</span> to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg">
              &copy; 2024 MERN Stack Developer. Crafting the future, one pixel
              at a time.
            </p>
          </div>
        </div>
